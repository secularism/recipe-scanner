...
- [ ] **UX-01**: 首页主 CTA、场景预设、收藏/历史入口形成清晰的视觉层级
- [ ] **UX-02**: 一键预设升级为更有场景感的做饭入口，而不是普通功能卡片
- [ ] **UX-03**: 生成页明显展示用户已选食材、调味料、菜系、口味的摘要反馈
- [ ] **UX-04**: 生成页支持更自然的恢复上次输入、清空输入与继续编辑流程
- [ ] **UX-05**: 生成页增加最近使用食材/调味料入口，减少重复操作
- [ ] **UX-06**: 本阶段不改匹配算法，只优化首页到生成页的体验链路
