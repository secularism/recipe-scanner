...
export const CANTONESE_HOME_RECIPES: Recipe[] = [
  {
    ...
    difficulty: 1,
    ingredients: ['egg'],
    seasonings: ['salt', 'soy-sauce', 'sesame-oil', 'scallion'],
    steps: [
  ...
  },
  {
    ...
    difficulty: 2,
    ingredients: ['chicken'],
    seasonings: ['ginger', 'scallion', 'salt', 'sesame-oil', 'soy-sauce'],
    steps: [
  ...
  },
  {
    ...
    seasonings: ['salt', 'sugar', 'scallion'],
    steps: [
  ...
  },
  {
    ...
    seasonings: ['vinegar', 'salt', 'soy-sauce', 'garlic', 'oil'],
    steps: [
  ...
  },
  {
    ...
    difficulty: 2,
    ingredients: ['ribs'],
    seasonings: ['soy-sauce', 'dark-soy', 'sugar', 'ginger', 'scallion', 'star-anise', 'oil'],
    steps: [
  ...
  },
  {
    ...
    seasonings: ['vinegar', 'soy-sauce', 'sesame-oil', 'salt', 'sugar', 'chili-oil', 'cilantro'],
    steps: [
  ...
  },
  {
    ...
    seasonings: ['soy-sauce', 'vinegar', 'sugar', 'sesame-oil', 'scallion', 'oil'],
    steps: [
