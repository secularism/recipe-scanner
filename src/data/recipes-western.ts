...
export const WESTERN_RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    cookTime: 30,
    difficulty: 2,
    ingredients: ['noodle', 'pork', 'tomato', 'onion'],
    seasonings: ['ketchup', 'olive-oil', 'garlic', 'salt', 'basil', 'pepper-powder'],
    steps: [
  ...
  },
  {
    ...
    cookTime: 20,
    difficulty: 2,
    ingredients: ['noodle', 'shrimp', 'garlic'],
    seasonings: ['butter', 'olive-oil', 'salt', 'pepper-powder', 'parsley'],
    steps: [
  ...
  },
  {
    ...
    cookTime: 20,
    difficulty: 2,
    ingredients: ['rice', 'carrot', 'spinach', 'mushroom', 'egg'],
    seasonings: ['sriracha', 'soy-sauce', 'sesame-oil', 'garlic', 'salt'],
    steps: [
  ...
  },
  {
    ...
    cookTime: 35,
    difficulty: 2,
    ingredients: ['rice', 'beef', 'potato', 'carrot', 'onion'],
    seasonings: ['curry-block' as any, 'oil', 'salt'],
    steps: [
  ...
  },
  {
    ...
    cookTime: 8,
    difficulty: 1,
    ingredients: ['tofu', 'seaweed' as any, 'scallion'],
    seasonings: ['miso' as any],
    steps: [
